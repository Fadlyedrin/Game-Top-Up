...
<head>
    ...
    <meta name="description"
        content="OxyGameStore Cara Tercepat Dan Termudah Untuk Pembelian Diamond Mobile Legends.">
    <meta name="robots" content="index,nofollow">
    <meta name="keywords"
        content="diamond ml murah, top up ml murah, diamond mobile legend murah, OxyGameStore">
        ...
        <div class="row mt-2" style="margin:0px">
            <div class="col-md-12 col-sm-12 col-lg-4">
                <div class="text-center text-md-left mb-2">
                    <img src="../image/zzz.jpg" class="img-responsive rounded mb-2" width="350px" height="200px">
                </div>
                ...
                <p class="mt-4 pr-4"><b><font color="#fff">Top Up Diamond Mobile Legends termurah & tercepat di OxyGameStore</font></b>
<br/>
<br/>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<img class=img-fluid src="../image/ML1.jpg">
                        ...
                        <div class="card">
                                ...
                                <h5 style="margin-left: 40px; ">Pilih nominal</h5>
                                    ...
                                    <hr><div class="mt-4" >
                                        ...
                                        ?>
                                            <input type="radio" id="service<?php echo $no; ?>" name="service" value="<?php echo $data['id_product']; ?>"><label onclick="ganti('service<?php echo $no; ?>')" id='service<?php echo $no; ?>' for='service<?php echo $no; ?>'><?php echo $data["jumlah_dm"]; ?><img style="margin-right: 3px !important;" height="18px" src="../image/dm.png"><?php echo $data["harga"];?></label>  
                    ...
                    <div class="card">
                            ...
                            <label class="mtdlabel" for="method2"><img src="../image/bni.png" class="img-fluid">
                            <p class="float-right">
