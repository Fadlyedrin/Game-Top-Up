...
<head>
    ...
    <meta name="description"
        content="OxyGameStore Cara Tercepat Dan Termudah Untuk Pembelian UC PUBG.">
    <meta name="robots" content="index,nofollow">
    <meta name="keywords"
        content="top up uc pubg murah, OxyGameStore">
    ...
    <div class="row mt-2" style="margin:0px">
        <div class="col-md-12 col-sm-12 col-lg-4">
            <div class="text-center text-md-left mb-2">
                <img src="../image/pubg.png" class="img-responsive rounded mb-2" width="300px" height="200px">
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img class=img-fluid src="../image/pubgser.png">
            <br>
                            ...
                            <h5 style="margin-left: 40px; ">Pilih nominal</h5>
                                <hr><div class="mt-4" >
                                    <div class="panel-topup">
                                        ...
                                        ?>
                                            <input type="radio" id="service<?php echo $no; ?>" name="service" value="<?php echo $data['id_product']; ?>"><label onclick="ganti('service<?php echo $no; ?>')" id='service<?php echo $no; ?>' for='service<?php echo $no; ?>'><?php echo $data["jumlah_dm"];?> <img style="margin-right: 3px !important;" height="18px" src="../image/uc.png"><?php echo $data["harga"]; ?></label>  
